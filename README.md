...
- ajout des images des artistes
- affichage d’une grille de 9 images
- suppression des noms sous les images pour rendre le jeu plus intéressant
- ajout d’un chronomètre de 1 minute
- ajout de 3 vies
- ajout d’un meilleur score (record)
...
- adaptation de l’interface pour afficher correctement les 9 images
...
- utilisation de shared_preferences pour enregistrer le meilleur score
- tests réguliers du projet dans le navigateur
- correction progressive des erreurs rencontrées

## Améliorations possibles
- ajout de niveaux de difficulté
- ajout de sons pour les bonnes et mauvaises réponses
- ajout d’animations
- ajout de plus d’artistes
